 ...
 * @param {string} email - Vendor email (defaults to davy@exploreni.com)
 * @example cy.loginAsVendor()
 * @example cy.loginAsVendor('siobhan@exploreni.com')
 */
Cypress.Commands.add('loginAsVendor', (email = 'davy@exploreni.com') => {
 ...
 * @param {string} email - Customer email (defaults to mary@exploreni.com)
 * @example cy.loginAsCustomer()
 * @example cy.loginAsCustomer('paddy@exploreni.com')
 */
Cypress.Commands.add('loginAsCustomer', (email = 'mary@exploreni.com') => {
