...
describe('Epic 11: Final UI & Internal Logic Regression Test', () => {
  ...
  describe('Part 1: System Boot & Data Seeding', () => {
    ...
    it('Step 4-7: Apply to become vendor and approve', () => {
      // Check if vendor@niexperiences.co.uk needs to apply or is already approved
      // For this test, we'll use davy@niexperiences.co.uk as active vendor
      // and ciaran@niexperiences.co.uk as pending vendor (from seed data)
    ...
    it('Step 10-13: Login as vendor and set phone number', () => {
      // Login as vendor (using davy@niexperiences.co.uk)
      cy.visit('/login');
  ...
  describe('Part 2: UI/UX Polish Verification', () => {
    ...
    it('Step 4: Login error toast/alert', () => {
      ...
      cy.get('input[name="email"]').type('mary@niexperiences.co.uk');
    ...
    it('Step 5: Login success toast/alert', () => {
      // Login successfully
      cy.visit('/login');
      cy.get('input[name="email"]').clear().type('mary@niexperiences.co.uk');
  ...
  describe('Part 3: Core Journey - Booking & Voucher Redemption UI', () => {
    it('Step 1-3: Find and select Auto-Confirm Tour for 2 people', () => {
      // Already logged in as mary@niexperiences.co.uk
      cy.visit('/experiences');
      cy.wait(1000);
